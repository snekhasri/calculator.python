...
root.geometry("420x500")    # x is small case here
...
# calculations 
Entry(root, textvariable=value, font=large_font,borderwidth=4,relief="solid").grid(row=0, 
...
Button(root, text="+", fg="red", command=lambda: 
    setexpression("+"), height=4,width=8,borderwidth=4,relief="solid").grid(row=1,column=0,pady=10)
Button(root, text="-", fg="red", command=lambda:
    setexpression("-"), height=4, width=8,borderwidth=4,relief="solid").grid(row=2, column=0, pady=10)
Button(root, text="X", fg="red", command=lambda: 
    setexpression("*"), height=4, width=8,borderwidth=4,relief="solid").grid(row=3, column=0,pady=10)
Button(root, text="/", fg="red", command=lambda: 
    setexpression("/"), height=4, width=8,borderwidth=4,relief="solid").grid(row=4, column=0,pady=10)
Button(root, text="1", fg="red", command=lambda: 
    setexpression("1"), height=4, width=8,borderwidth=4,relief="solid").grid(row=1, column=1,pady=10)
Button(root, text="2", fg="red", command=lambda: 
    setexpression("2"), height=4, width=8,borderwidth=4,relief="solid").grid(row=1, column=2,pady=10)
Button(root, text="3", fg="red", command=lambda: 
    setexpression("3"), height=4, width=8,borderwidth=4,relief="solid").grid(row=1, column=3,pady=10)
Button(root, text="4", fg="red", command=lambda: 
    setexpression("4"), height=4, width=8,borderwidth=4,relief="solid").grid(row=2, column=1,pady=10)
Button(root, text="5", fg="red", command=lambda: 
    setexpression("5"), height=4, width=8,borderwidth=4,relief="solid").grid(row=2, column=2)
Button(root, text="6", fg="red", command=lambda: 
    setexpression("6"), height=4, width=8,borderwidth=4,relief="solid").grid(row=2, column=3,pady=10)
Button(root, text="7", fg="red", command=lambda: 
    setexpression("7"), height=4, width=8,borderwidth=4,relief="solid").grid(row=3, column=1,pady=10)
Button(root, text="8", fg="red", command=lambda: 
    setexpression("8"), height=4, width=8,borderwidth=4,relief="solid").grid(row=3, column=2,pady=10)
Button(root, text="9", fg="red", command=lambda: 
    setexpression("9"), height=4, width=8,borderwidth=4,relief="solid").grid(row=3, column=3,pady=10)
Button(root, text="0", fg="red", command=lambda: 
    setexpression("0"), height=4, width=8,borderwidth=4,relief="solid").grid(row=4, column=2,pady=10)
Button(root, text=".", fg="red", command=lambda: 
    setexpression("."), height=4, width=8,borderwidth=4,relief="solid").grid(row=4, column=1,pady=10)
...
width=8,borderwidth=4,relief="solid").grid(row=4, column=3, pady=10)
...
Button(root, text="Clear", fg="red", command=clear, height=4, 
    width=20,borderwidth=4,relief="solid").grid(row=5, column=1, pady=10)
